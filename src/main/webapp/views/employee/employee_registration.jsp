...
<link
	href="resource/assets/plugins/custom/vis-timeline/vis-timeline.bundle.css"
	rel="stylesheet" type="text/css" />
						...
						<div
							...
							<div
								...
								<h1 class="text-gray-900 fw-bold my-1 fs-2">
									인사관리 <small class="text-muted fs-6 fw-normal ms-1"></small>
								</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb fw-semibold fs-base my-1">
									<li class="breadcrumb-item text-muted"><a href="index.go"
						...
						<div class="container-xxl"
							...
							<form action="/employee/registration" method="post">
								<div style="margin-top: 20px">
									부서 <select class="form-select" aria-label="Select example"
										name="deptName">
								...
								<div style="margin-top: 20px">
									직책 <select class="form-select" aria-label="Select example"
										name="positionType">
								...
								<div style="margin-top: 20px">
									비상 연락처 <input type="text" name="empEmergencyPhone"
										class="form-control" placeholder="비상 연락망을 입력해주세요" />
								</div>

								<div style="margin-top: 20px">
									개인 연락처 <input type="text" name="empPhone" class="form-control"
										placeholder="개인 번호를 입력해주세요" />
								</div>

								<div style="margin-top: 20px">
									내선 번호 <input type="text" name="empExtNo" class="form-control" placeholder="내선 번호를 입력해주세요" />
								</div>
								<div style="margin-top: 20px">
									성별
									<div class="form-check form-check-custom form-check-solid">
										<input class="form-check-input" name="empGender" type="radio" value="M" id="flexRadioDefault" checked="checked" /> 
										<label class="form-check-label" for="flexRadioDefault"> 남자 </label>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
										<input class="form-check-input" name="empGender" type="radio" value="W" id="flexRadioDefault" /> 
										<label class="form-check-label" for="flexRadioDefault"> 여자 </label>
									</div>
								</div>

								<div style="margin-top: 20px">
									생년월일 <input type="date" name="empBirth" class="form-control brith" /> 
								...
								<div style="margin-top: 20px">
									<div class="d-flex flex-stack flex-wrap flex-sm-nowrap">
										<div>주소</div>
										<input type="button" onclick="findlocation()"
											class="btn btn-primary" id="kt_toolbar_primary_button"
											value="주소 찾기" />
									</div>
								...
								<div style="margin-top: 20px">
									최종 학력 <select class="form-select" aria-label="Select example"
										name="education">
										<option value="초등학교 졸업">초등학교 졸업</option>
										<option value="중학교 졸업">중학교 졸업</option>
										<option value="고등학교 졸업">고등학교 졸업</option>
										<option value="대학교 졸업">대학교 졸업</option>
										<option value="직업전문학원·학교 및 기타학력 졸업">직업전문학원·학교 및 기타학력
											졸업</option>
									</select>

									<div style="margin-top: 5px">
										<input type="text" class="form-control" placeholder="학교"
											name="schoolName" />
									</div>
									<div style="margin-top: 5px">
							...
							<button type="button" class="btn btn-primary submit_btn"
								id="kt_toolbar_primary_button" style="margin: 20px 0px;">등록</button>
