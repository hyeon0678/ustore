					...
					<!--================================메인 내용들어가는부분================================================-->
							...
							<div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
									...
									<ul class="breadcrumb fw-semibold fs-base my-1">
										...
										<li class="breadcrumb-item text-muted">익명게시판</li>
										<li class="breadcrumb-item text-gray-900">익명게시판 글쓰기</li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
							<div class="container-xxl" style="background-color: white;margin: 20px;">
								...
								<div style="margin-top:20px">
									<textarea class="form-control" placeholder="내용을 입력해주세요" style="height: 600px;"></textarea>
								</div>
