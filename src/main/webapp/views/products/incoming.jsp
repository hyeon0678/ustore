			...
			<div class="wrapper d-flex flex-column flex-row-fluid"
				...
				<div class="content fs-6 d-flex flex-column flex-column-fluid"
					...
					<h1 class="text-gray-900 fw-bold my-1 fs-2"
						style="margin-left: 50px;">입고 관리</h1>
					<!--================================메인 내용들어가는부분================================================-->
										...
										<tbody id="incomingTableBody">
											<c:forEach items="${incomList}" var="List">
												<tr>
													...
													<td><a href="#"
														class="btn btn-link text-primary confirmButton"
														data-order-idx="${List.orderIdx}" data-bs-toggle="modal"
														data-bs-target="#kt_modal_1">&emsp;${List.orderIdx}</a></td>
								...
								$('#modalTableBody').off('click',
										...
										function() {
											...
											sendRequest(productId,
													totalQuantity, orderIdx);
										});
							}

							function sendRequest(productId, totalQuantity,
									orderIdx) {
																...
																$.each(
																				...
																				function(
																					...
																					var newRow = '<tr>'
																							...
																							+ item.expArrivalDate
																							+ '</td>'
																							+ '<td><a href="#" class="btn btn-link text-primary confirmButton" data-order-idx="' + item.orderIdx + '" data-bs-toggle="modal" data-bs-target="#kt_modal_1">'
																							+ '&emsp;'
																							+ item.orderIdx
																							+ '</a></td>'
																							+ '<td>'
