    ...
    function submitForm(button) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var expArrivalDateInput = document.createElement('input');
                expArrivalDateInput.type = 'hidden';
                expArrivalDateInput.name = 'exp_arrival_date';
                expArrivalDateInput.value = document.getElementById('birthdate').value;
                form.appendChild(expArrivalDateInput);
