				...
				<div class="wrapper d-flex flex-column flex-row-fluid"
					...
					<div class="content fs-6 d-flex flex-column flex-column-fluid"
						...
						<h1 class="text-gray-900 fw-bold my-1 fs-2"
							style="margin-left: 50px;">재고 관리</h1>
						<!--================================메인 내용들어가는부분================================================-->
						<!--사이드바 넣는곳  -->
								...
								<div class="card card-flush">
									...
									<div class="card-header align-items-center py-5 gap-2 gap-md-5">
										...
										<button type="button" class="btn btn-primary"
											...
											data-bs-target="#kt_modal_scrollable_2">품목 추가</button>
											...
											<div class="modal-dialog modal-dialog-scrollable">
												<div class="modal-content">
													<div class="modal-header">
														<h2 class="modal-title" style="color: #c6da52;">물품 항목
															추가</h2>
													...
													<form id="myForm" action="stock/stockmanagement/insert"
														method="post">
																	...
																	<thead>
																		<tr class="fw-semibold fs-6 text-gray-800">
																			...
																			<td colspan="2"><input type="text"
																				class="form-control" placeholder="물품 이름을 입력 해주세요."
																				name="productName" /></td>
																	...
																	<tbody>
																		<tr class="fw-semibold fs-6 text-gray-800">
																			<td class="min-w-125px"
																				style="vertical-align: bottom;">분류</td>
																			<td>대분류 <select
																		...
																		<tr class="fw-semibold fs-6 text-gray-800">
																			<td class="min-w-125px"
																				style="vertical-align: bottom;">단위(파렛트)</td>
																			<td colspan="2"><input type="text"
																				class="form-control" placeholder="단위(파렛트)를 입력 해주세요."
																				name="unitQuantity" /></td>
																		</tr>
																		<tr class="fw-semibold fs-6 text-gray-800">
																			<td class="min-w-125px"
																				style="vertical-align: bottom;">단가(낱개)</td>
																			<td colspan="2"><input type="hidden"
																				name="empIdx" value="${principal.username}" /><input
																				type="text" class="form-control"
																				placeholder="단가(낱개)를 입력 해주세요." name="purchasePrice" /></td>
																		</tr>
																	</tbody>
														...
														<div class="modal-footer">
															<button id="submitButton" class="btn btn-primary">항목
																추가</button>
												...
												<c:forEach items="${list}" var="stock">
													<tr>
														...
														<td>
															<div class="d-flex">
																<a
																	href="/stock/stockdetail/list?productId=${stock.productId}"
																	class="btn-link text-gray-800 text-hover-primary fs-5 fw-bold mb-1">
																	${stock.productName} </a>
															</div>
														</td>
														<td><c:choose>
																<c:when test="${stock.stock gt 0}">
																	<c:set var="roundedStock"
																		value="${fn:substringBefore(fn:replace(Math.ceil(stock.stock / stock.unitQuantity), '\\\\.0', ''), '.')}" />
        ${roundedStock}
    </c:when>
																<c:otherwise>
        0
														...
														<td><button class="btn btn-primary"
																onclick="confirmDelete('${stock.productId}')">삭제</button></td>
													</tr>
												</c:forEach>
