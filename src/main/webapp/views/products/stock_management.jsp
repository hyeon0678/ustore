...
<div class="modal fade" tabindex="-1" id="kt_modal_scrollable_2">
	...
	<table class="table table-hover table-rounded ta	ble-striped border gy-7 gs-7">
		...
		<tbody>
			<tr>
				<td>분류</td>
				<td>대분류<select class="form-select form-select-solid" data-control="select2" data-placeholder="생필품" data-hide-search="true">
    <option></option>
    <option value="1">Option 1</option>
    <option value="2">Option 2</option>
    <
</select></td>
				<td>중분류<select class="form-select form-select-solid" data-control="select2" data-placeholder="생활 잡화" data-hide-search="true">
    <option></option>
    <option value="1">Option 1</option>
    <option value="2">Option 2</option>
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															...
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">코카콜라</a>
													...
													<td>
														<div class="d-flex">
															...
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/71.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															<!--begin::Thumbnail-->
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/58.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															<!--begin::Thumbnail-->
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/52.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															<!--begin::Thumbnail-->
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/76.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															<!--begin::Thumbnail-->
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/207.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															<!--begin::Thumbnail-->
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/50.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															<!--begin::Thumbnail-->
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/193.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															<!--begin::Thumbnail-->
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/169.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															<!--begin::Thumbnail-->
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/177.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
												...
												<tr>
													...
													<td>
														<div class="d-flex">
															<!--begin::Thumbnail-->
															<a href="apps/ecommerce/catalog/edit-category.jsp" class="symbol symbol-50px">
																<span class="symbol-label" style="background-image:url(/media//stock/ecommerce/151.png);"></span>
															</a>
															<!--end::Thumbnail-->
															<div class="ms-5">
																<!--begin::Title-->
